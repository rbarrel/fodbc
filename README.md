...
The version available upsteam didn't compile, so this repository contains the changes necessary to get the source code to compile independently and without any warnings or errors.
